...
import com.tulun.study.weixin_saomaPay.pay.util.PayConfigUtil;
import com.tulun.study.weixin_saomaPay.pay.util.PayToolUtil;
import com.tulun.study.weixin_saomaPay.pay.util.QRUtil;
import com.tulun.study.weixin_saomaPay.pay.util.XMLUtil4jdom;
...
public class UserController extends BaseController {
	...
	public Map<String, Object> hadPay(UserVO user, HttpServletRequest request, HttpServletResponse response, ModelMap modelMap) {
		try {
